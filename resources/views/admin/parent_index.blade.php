        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('parent.create') }}" class="btn btn-primary" style="position: absolute; right: 20px;">Add New</a>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            @foreach ($parents as $parent)
                                <tr>
                                    ...
                                    <td>{{ $parent->phone }}</td>
                                    <td>
                                        <a href="{{ route('assign.student', $parent->id) }}" class="btn btn-primary">Assign Student</a>
                                        <a href="{{ route('parent.view', $parent->id) }}" class="btn btn-info">Parent's Student</a>
                                        <a href="{{ route('parent.edit', $parent->id) }}" class="btn btn-success">Edit</a>
                                        <form action="{{ route('parent.destory', $parent->id) }}" method="POST" class="d-inline" id="delete-form-{{ $parent->id }}">
                                            @csrf
                                            @method('DELETE')
