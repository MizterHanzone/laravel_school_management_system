...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="{{route('parent.change.password')}}"
                                class="nav-link {{ request()->routeIs('parent.change.password') ? 'active' : '' }}">
        ...
        <footer class="main-footer">
            <strong>&copy; {{ date('Y') }} Parent Panel.</strong> All rights reserved.
        </footer>
    </div>
