        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-flex align-items-center">
                    ...
                    <a href="{{ route('teacher.dashboard') }}" class="nav-link"> {{ Auth::user()->name }} {{Auth::user()->last_name}}</a>
                </li>                
            </ul>
            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" role="menu">
                        ...
                        <li class="nav-item">
                            <a href="{{route('teacher.teacher.profile')}}"
                                class="nav-link {{ request()->routeIs('teacher.teacher.profile') ? 'active' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{route('teacher.teacher.change.password')}}"
                                class="nav-link {{ request()->routeIs('teacher.teacher.change.password') ? 'active' : '' }}">
