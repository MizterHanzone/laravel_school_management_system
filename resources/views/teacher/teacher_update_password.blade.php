...
@section('title', 'Teacher update password')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Teacher update password</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Teacher update password</h3>
                            </div>
                            <form action="{{route('teacher.teacher.update.password')}}" method="POST">
                                @csrf
                                {{-- @method('PUT') --}}
                                <div class="card-body">
